...
namespace SimpleNetwork
{
    ...
    public class NeuralNetwork : BaseBehaviour
    {
        ...
        void Start()
        {
            ...
            CreateSynapse(in1, hidden2, 1.2f, false);
            CreateSynapse(in2, hidden1, 2.55f, false);
            CreateSynapse(in2, hidden2, 0.4f, false);
            ...
            List<float> inputValues = new List<float>() { 0, -0.1f };
        ...
        public List<float> Fire(List<Neuron> inputNeurons, List<float> inputValues)
        {
            ...
            while (currentNeurons != null && currentNeurons.Count > 0)
            {
                ...
                {
                    n.ComputeOutput();
                    print("Neuron " + n.Id + ", output: " + n.Output);
                    retval.Add(n.Output);
